...
for i = 1:9
    if (i == 8)
        fprintf(file, "V_b & %7.7e\\\\\\hline ", double(X(i)));
    elseif (i == 9)
        fprintf(file, "V_c & %7.7e\\\\\\hline ", double(X(i)));
    else
        fprintf(file, "V_%i & %7.7e\\\\\\hline ", i, double(X(i)));
    endif
endfor

fprintf(file, "I_b & %7.7e\\\\\\hline ", double(Ib));
fprintf(file, "I_c & %7.7e\\\\\\hline ", double(Ic));
